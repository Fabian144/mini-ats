...
A lightweight, modern Applicant Tracking System built with **React**, **Vite**, and **Supabase** in Swedish. Manage job openings and track candidates through the hiring pipeline using a drag-and-drop Kanban board and more.
